                        ...
                        <div class="nav-menu">
                            <nav class="mainmenu">
                                <ul>
                                    ...
                                    <li><a href="<?php echo base_url() . 'registrar-usuario' ?>">REGISTRARSE</a></li>
                                </ul>
                            </nav>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row">
                <?php foreach ($habitacion as $habitaciones) : ?>
                        ...
                        <div class="room-item">
                            ...
                            <div class="ri-text">
                                ...
                                <div class="">
                                    ...
                                    <a href="<?php echo base_url().'ver-Ubicacion/' ?>" style="margin: 50px" class="primary-btn" >Ver ubicacion</a>
                                </div>
                                <!-- data-toggle="modal" data-target="#ubicacion" -->
                                <!-- Modal -->
                    ...
                    <!-- <div class="modal fade bd-example-modal-lg" id="ubicacion" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <script async src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB0DAL6nKoyzabQVaSO8AIrQDCrT44Ahcg&callback=initMap">
                                </script>
                                <div id="map"></div>
                                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15894.865402406916!2d-76.686209670663!3d5.1492827595885!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xbd7c90c879eb4625!2sHotel%20Los%20Balcones!5e0!3m2!1ses!2sco!4v1668742686013!5m2!1ses!2sco" 
                                    width="600" 
                                    height="600" 
